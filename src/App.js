  ...
  return (  
    <div id="Eyp" className="App App-header crt">
     ...
     {/*  <div className="console">
      ...
      <p>MakerCreate is a YSWS (You Ship, We Ship) program @ HackClub. You spend time making hardware/CAD projects on an approved editor, and we ship you a 3D printer of your choice! (You can also spend earned logs on our <bold>MakerShop&trade;</bold>)</p>
